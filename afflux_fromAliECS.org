...
1. org capture
   ...
   - [[URL][from outside]]
     - [[https://orgmode.org/manual/Protocols.html#Protocols][protocols]] CANNOT bring title in ... so, after dosth, shell give u a success processed link NOT include title
